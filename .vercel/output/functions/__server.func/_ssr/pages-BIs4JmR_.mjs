...
//#region node_modules/.nitro/vite/services/ssr/assets/pages-BIs4JmR_.js
...
function AdminPagesPage() {
	...
	const { data: pages = [], isLoading } = useQuery({
		...
		queryFn: async () => {
			let q = supabase.from("pages").select("*").is("deleted_at", null).order("updated_at", { ascending: false });
