...
//#region node_modules/.nitro/vite/services/ssr/assets/dashboard-Dfrg2xMA.js
...
function PageCard({ page }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
		...
		children: [
			...
			page.status === "published" && page.expires_at && typeof page.expires_at === "string" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-3",
