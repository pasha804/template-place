...
//#region node_modules/.nitro/vite/services/ssr/assets/FAQSection-NT9vxkBs.js
					...
					children: faqs.map((faq, i) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: cn("text-sm font-semibold leading-snug transition-colors", isOpen ? "text-primary" : "text-foreground"),
									children: faq.q
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: cn("flex h-7 w-7 shrink-0 items-center justify-center rounded-full border transition-all duration-300", isOpen ? "border-primary/40 bg-primary/15 text-primary rotate-0" : "border-[var(--glass-border)] text-muted-foreground"),
