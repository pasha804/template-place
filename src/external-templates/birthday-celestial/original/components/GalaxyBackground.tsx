...
export const GalaxyBackground = memo(function GalaxyBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden galaxy-bg" style={{ willChange: "transform" }}>
      {/* nebula clouds */}
      <div className="absolute -left-1/4 top-[-10%] h-[70vh] w-[70vw] animate-nebula rounded-full bg-nebula/30 blur-[100px]" style={{ willChange: "transform" }} />
      <div
        className="absolute -right-1/5 top-1/3 h-[60vh] w-[60vw] animate-nebula rounded-full bg-magenta/25 blur-[110px]"
        style={{ animationDelay: "-8s", willChange: "transform" }}
      />
      <div
        className="absolute bottom-[-15%] left-1/4 h-[55vh] w-[55vw] animate-nebula rounded-full bg-violet/25 blur-[120px]"
        style={{ animationDelay: "-14s", willChange: "transform" }}
      />
