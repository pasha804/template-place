...
export default function OpeningPage({ setCurrentPage, setMusicPlaying, setShowMusicPlayer, personName }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center relative">
      ...
      >
        ...
        <img
          src="/templates/sorry-teddy/gifs/teddy-walking.gif"
      ...
      >
        <motion.p
          ...
          className="text-pink-200 text-2xl leading-relaxed"
        >
          Sorry {personName || "Jana"} ! ❤️
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
